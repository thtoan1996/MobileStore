...
using MobileStore.Web.Infrastructure.Core;

[assembly: OwinStartup(typeof(MobileStore.Web.App_Start.Startup))]

namespace MobileStore.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(MobileStoreDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<MobileStoreDbContext>());
